...
public class GameManager {
    ...
    public static void main(String[] args) {
        GameManager g = new GameManager("S");
        for (Card c : g.getPlayersCardsSet(0)) {
            System.out.println(c.toString());
            
        }
        Card[] c = new Card[]{new Card("1","L"),new Card("7","L"),new Card("9","S"),new Card("1","Z")};
        List<Card> list = new LinkedList<Card>(Arrays.asList(c));
        System.out.println(g.getWinerOfRound(list,0));
        System.out.println(g.indexOfHigestValue(g.getPlayersCardsSet(0)));
